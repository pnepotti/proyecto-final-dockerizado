...
# Modelo para almacenar los doctores
...
# Modelo para almacenar los pacientes
...
# Modelo para almacenar las imágenes de resonancia magnética
...
class ImagenMRI(models.Model):
    ...
    def __str__(self):
        return f"Resonancia de {self.patient.name} subida en {self.uploaded_at}"

# Modelo para almacenar las predicciones


class Prediction(models.Model):
    resonancia_image = models.ForeignKey(
        ImagenMRI, on_delete=models.CASCADE, related_name='predictions')
    ...
    diagnosed_at = models.DateTimeField(default=now)

    def __str__(self):
        return f"Predicción: {self.disease} para resonancia: {self.resonancia_image}"
